...
**Bar Chart**= compareaggregated measures by the length or heigh of bars.    
...
**Histogram** = Use to know the distribution  
**Tree plot** = Data distributoin divided in categories. EX = Distribution of salary per area,manager and position 
**Waterfall** = Used to know the influence a value in a total ex= influence of costs, shipping on total sales  
...
**Dimensions** = Quaifying attribute, qualitative

**Measure** = Numeric value, quantitative
